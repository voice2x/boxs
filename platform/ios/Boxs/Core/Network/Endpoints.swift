...
enum Endpoints {
    ...
    static func expenseChanges(cursor: String?, since: String? = nil, limit: Int = 200) -> Endpoint {
    ...
    static func habitChanges(cursor: String?, since: String? = nil, limit: Int = 200) -> Endpoint {
        var q: [URLQueryItem] = [URLQueryItem(name: "limit", value: "\(limit)")]
        if let cursor { q.append(URLQueryItem(name: "cursor", value: cursor)) }
        if let since { q.append(URLQueryItem(name: "since", value: since)) }
    ...
    static func checkinChanges(cursor: String?, since: String? = nil, limit: Int = 200) -> Endpoint {
        var q: [URLQueryItem] = [URLQueryItem(name: "limit", value: "\(limit)")]
        if let cursor { q.append(URLQueryItem(name: "cursor", value: cursor)) }
        if let since { q.append(URLQueryItem(name: "since", value: since)) }
    ...
    static func todoChanges(cursor: String?, since: String? = nil, limit: Int = 200) -> Endpoint {
        var q: [URLQueryItem] = [URLQueryItem(name: "limit", value: "\(limit)")]
        if let cursor { q.append(URLQueryItem(name: "cursor", value: cursor)) }
        if let since { q.append(URLQueryItem(name: "since", value: since)) }
